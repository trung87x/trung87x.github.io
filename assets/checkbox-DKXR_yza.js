...
`;function Ee(){return e.jsxs(i,{children:[e.jsx(c,{name:"allow_embedding"}),e.jsx(t,{children:"Allow embedding"}),e.jsx(d,{children:"Allow others to embed your event details on their own site."})]})}const Se=`import { Checkbox, CheckboxField } from "@/components/ui-kit/checkbox";
...
`;function $e(){return e.jsxs(_,{className:"flex items-center justify-between gap-4",children:[e.jsx(t,{children:"Allow embedding"}),e.jsx(c,{name:"allow_embedding"})]})}const Ae=`import { Checkbox } from "@/components/ui-kit/checkbox";
import { Label } from "@/components/ui-kit/fieldset";
...
`;function ze(){return e.jsx(c,{color:"sky",defaultChecked:!0})}const Ge=`import { Checkbox } from "@/components/ui-kit/checkbox";

export default function Example() {
  return <Checkbox color="sky" defaultChecked />;
}
`;function Re(){return e.jsx(c,{name:"embed",value:"allow"})}const Te=`import { Checkbox } from "@/components/ui-kit/checkbox";

export default function Example() {
  return <Checkbox name="embed" value="allow" />;
}
`;function We(){return e.jsx(c,{defaultChecked:!0})}const Ne=`import { Checkbox } from "@/components/ui-kit/checkbox";

export default function Example() {
  return <Checkbox defaultChecked />;
}
`,C=["Show on events page","Allow embedding"];function He(){let[r,o]=b.useState(["Show on events page"]);return e.jsxs(u,{role:"group","aria-label":"Discoverability",children:[e.jsxs(i,{children:[e.jsx(c,{checked:r.length>0,indeterminate:r.length!==C.length,onChange:n=>o(n?C:[])}),e.jsx(t,{children:"Select all"})]}),C.map(n=>e.jsxs(i,{children:[e.jsx(c,{name:n,checked:r.includes(n),onChange:f=>o(k=>f?[...k,n]:k.filter(g=>g!==n))}),e.jsx(t,{children:n})]},n))]})}const Me=`import {
  Checkbox,
  CheckboxField,
  CheckboxGroup,
...
`;function Pe(){let[r,o]=b.useState(!0);return e.jsx(c,{checked:r,onChange:o})}const Ie=`import { Checkbox } from "@/components/ui-kit/checkbox";
import { useState } from "react";
...
`;function Ve(){return e.jsxs(E,{children:[e.jsx(S,{children:"Discoverability"}),e.jsx($,{children:"Decide where your events can be found across the web."}),e.jsxs(u,{children:[e.jsxs(i,{children:[e.jsx(c,{name:"discoverability",value:"show_on_events_page",defaultChecked:!0}),e.jsx(t,{children:"Show on events page"}),e.jsx(d,{children:"Make this event visible on your profile."})]}),e.jsxs(i,{children:[e.jsx(c,{name:"discoverability",value:"allow_embedding"}),e.jsx(t,{children:"Allow embedding"}),e.jsx(d,{children:"Allow others to embed your event details on their own site."})]})]})]})}const Ue=`import {
  Checkbox,
  CheckboxField,
  CheckboxGroup,
} from "@/components/ui-kit/checkbox";
...
`;function Oe(){return e.jsxs(E,{children:[e.jsx(S,{children:"Discoverability"}),e.jsx($,{children:"Decide where your events can be found across the web."}),e.jsxs(u,{children:[e.jsxs(i,{children:[e.jsx(c,{name:"discoverability",value:"show_on_events_page"}),e.jsx(t,{children:"Show on events page"}),e.jsx(d,{children:"Make this event visible on your profile."})]}),e.jsxs(i,{disabled:!0,children:[e.jsx(c,{name:"discoverability",value:"allow_embedding"}),e.jsx(t,{children:"Allow embedding"}),e.jsx(d,{children:"Allow others to embed your event details on their own site."})]})]})]})}const Xe=`import {
  Checkbox,
  CheckboxField,
  CheckboxGroup,
} from "@/components/ui-kit/checkbox";
