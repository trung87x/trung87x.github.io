...
`;function j(){return e.jsxs(o,{children:[e.jsx(n,{children:"Allow embedding"}),e.jsx(a,{children:"Allow others to embed your event details on their own site."}),e.jsx(i,{name:"allow_embedding"})]})}const S=`import { Description, Label } from "@/components/ui-kit/fieldset";
import { Switch, SwitchField } from "@/components/ui-kit/switch";
...
`;function y(){return e.jsxs(l,{className:"flex items-center gap-4",children:[e.jsx(i,{name:"allow_embedding"}),e.jsx(n,{children:"Allow embedding"})]})}const L=`import { Label } from "@/components/ui-kit/fieldset";
...
`;function D(){return e.jsx(i,{color:"sky",defaultChecked:!0})}const F=`import { Switch } from "@/components/ui-kit/switch";

export default function Example() {
  return <Switch color="sky" defaultChecked />;
}
`;function _(){return e.jsx(i,{name:"embed",value:"allow"})}const A=`import { Switch } from "@/components/ui-kit/switch";

export default function Example() {
  return <Switch name="embed" value="allow" />;
}
`;function C(){return e.jsx(i,{defaultChecked:!0})}const E=`import { Switch } from "@/components/ui-kit/switch";

export default function Example() {
  return <Switch defaultChecked />;
}
`;function z(){let[r,t]=m.useState(!0);return e.jsx(i,{checked:r,onChange:t})}const R=`import { Switch } from "@/components/ui-kit/switch";
...
`;function W(){return e.jsxs(s,{children:[e.jsxs(o,{children:[e.jsx(n,{children:"Show on events page"}),e.jsx(a,{children:"Make this event visible on your profile."}),e.jsx(i,{name:"show_on_events_page",defaultChecked:!0})]}),e.jsxs(o,{children:[e.jsx(n,{children:"Allow embedding"}),e.jsx(a,{children:"Allow others to embed your event details on their own site."}),e.jsx(i,{name:"allow_embedding"})]})]})}const G=`import { Description, Label } from "@/components/ui-kit/fieldset";
import { Switch, SwitchField, SwitchGroup } from "@/components/ui-kit/switch";
...
`;function N(){return e.jsxs(d,{children:[e.jsx(h,{children:"Discoverability"}),e.jsx(w,{children:"Decide where your events can be found across the web."}),e.jsxs(s,{children:[e.jsxs(o,{children:[e.jsx(n,{children:"Show on events page"}),e.jsx(a,{children:"Make this event visible on your profile."}),e.jsx(i,{name:"show_on_events_page",defaultChecked:!0})]}),e.jsxs(o,{children:[e.jsx(n,{children:"Allow embedding"}),e.jsx(a,{children:"Allow others to embed your event details on their own site."}),e.jsx(i,{name:"allow_embedding"})]})]})]})}const $=`import {
  Description,
  Fieldset,
  Label,
  Legend,
...
`;function M(){return e.jsxs(d,{children:[e.jsx(h,{children:"Discoverability"}),e.jsx(w,{children:"Decide where your events can be found across the web."}),e.jsxs(s,{children:[e.jsxs(o,{children:[e.jsx(n,{children:"Show on events page"}),e.jsx(a,{children:"Make this event visible on your profile."}),e.jsx(i,{name:"discoverability",value:"show_on_events_page"})]}),e.jsxs(o,{disabled:!0,children:[e.jsx(n,{children:"Allow embedding"}),e.jsx(a,{children:"Allow others to embed your event details on their own site."}),e.jsx(i,{name:"discoverability",value:"allow_embedding"})]})]})]})}const T=`import {
  Description,
  Fieldset,
  Label,
  Legend,
