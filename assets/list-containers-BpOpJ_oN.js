import{j as e}from"./index-Cfbom0r9.js";import{P as s}from"./PreviewWrapper-eNzEzQtB.js";const d=[{id:1}];function t(){return e.jsx("ul",{role:"list",className:"divide-y divide-gray-200",children:d.map(n=>e.jsx("li",{className:"py-4"},n.id))})}const a=`const items = [
  { id: 1 },
  // More items...
]
