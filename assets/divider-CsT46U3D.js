import{j as e,aD as o}from"./index-B7qH8gVZ.js";import{P as a}from"./PreviewWrapper-DYMCDcbn.js";function i({soft:n=!1,className:r,...t}){return e.jsx("hr",{role:"presentation",...t,className:o(r,"w-full border-t",n&&"border-zinc-950/5 dark:border-white/5",!n&&"border-zinc-950/10 dark:border-white/10")})}function s(){return e.jsx(i,{})}const d=`import { Divider } from "@/components/ui-kit/divider";

export default function Example() {
  return <Divider />;
}
`;function c(){return e.jsx(i,{soft:!0})}const m=`import { Divider } from "@/components/ui-kit/divider";
