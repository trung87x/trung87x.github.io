...
`;function Pe(){let[n,o]=b.useState(!0);return e.jsx(c,{checked:n,onChange:o})}const Ie=`import { Checkbox } from "@/components/ui-kit/checkbox";
import { useState } from "react";
...
`;function Oe(){return e.jsxs(E,{children:[e.jsx(S,{children:"Discoverability"}),e.jsx($,{children:"Decide where your events can be found across the web."}),e.jsxs(p,{children:[e.jsxs(i,{children:[e.jsx(c,{name:"discoverability",value:"show_on_events_page"}),e.jsx(t,{children:"Show on events page"}),e.jsx(d,{children:"Make this event visible on your profile."})]}),e.jsxs(i,{disabled:!0,children:[e.jsx(c,{name:"discoverability",value:"allow_embedding"}),e.jsx(t,{children:"Allow embedding"}),e.jsx(d,{children:"Allow others to embed your event details on their own site."})]})]})]})}const Xe=`import {
  Checkbox,
  CheckboxField,
  CheckboxGroup,
} from "@/components/ui-kit/checkbox";
