...
`;function T(){let[t,n]=o.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(s,{type:"button",onClick:()=>n(!0),children:"Delete repository"}),e.jsxs(i,{open:t,onClose:n,size:"sm",children:[e.jsx(l,{children:"Verification required"}),e.jsx(a,{children:"To continue, please enter your password."}),e.jsx(p,{children:e.jsx(u,{autoFocus:!0,name:"password",type:"password","aria-label":"Password",placeholder:"•••••••"})}),e.jsxs(c,{children:[e.jsx(s,{plain:!0,onClick:()=>n(!1),children:"Cancel"}),e.jsx(s,{onClick:()=>n(!1),children:"Continue"})]})]})]})}const D=`import {
  Alert,
  AlertActions,
  AlertBody,
  AlertDescription,
