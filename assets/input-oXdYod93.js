import{j as n,r as o}from"./index-BUE_4nSx.js";import{P as m}from"./PreviewWrapper-C5kxKQgy.js";import{I as e,a as s}from"./input-iPFv-sYW.js";import{b as i,L as a,D as p,E as u}from"./fieldset-CqPvSkW4.js";import{F as c}from"./MagnifyingGlassIcon-Bk0-UJg9.js";import{W as d}from"./field-BQNjiGlu.js";import"./clsx-B-dksMZM.js";import"./useFocusRing-DcMgcFf7.js";import"./use-slot-BZcd_w4P.js";import"./disabled-1up_um9U.js";import"./label-CN3TFCLp.js";import"./render-CNyBWpu3.js";import"./use-sync-refs-Dh0umLOC.js";import"./dom-BlW_0b_t.js";import"./description-11b0SVwG.js";import"./form-fields-DC_tpJae.js";import"./index-5-nG4q7h.js";import"./hidden-c0o-GYKL.js";function f(){return n.jsx(e,{"aria-label":"Full name",name:"full_name"})}const x=`import { Input } from "@/components/ui-kit/input";

export default function Example() {
  return <Input aria-label="Full name" name="full_name" />;
}
`;function h(){return n.jsxs(i,{children:[n.jsx(a,{children:"Full name"}),n.jsx(e,{name:"full_name"})]})}const j=`import { Field, Label } from "@/components/ui-kit/fieldset";
...
`;function b(){return n.jsxs(i,{children:[n.jsx(a,{children:"Product name"}),n.jsx(p,{children:"Use the name you'd like people to see in their cart."}),n.jsx(e,{name:"product_name"})]})}const F=`import { Description, Field, Label } from "@/components/ui-kit/fieldset";
import { Input } from "@/components/ui-kit/input";
...
`;function I(){return n.jsxs(i,{children:[n.jsx(a,{children:"Your website"}),n.jsx(e,{type:"url",name:"url"})]})}const L=`import { Field, Label } from "@/components/ui-kit/fieldset";
import { Input } from "@/components/ui-kit/input";
...
`;function g(){return n.jsxs(i,{disabled:!0,children:[n.jsx(a,{children:"Full name"}),n.jsx(e,{name:"full_name"})]})}const k=`import { Field, Label } from "@/components/ui-kit/fieldset";
import { Input } from "@/components/ui-kit/input";
...
`;function _({errors:r}){return n.jsxs(i,{children:[n.jsx(a,{children:"Full name"}),n.jsx(e,{name:"full_name",invalid:r.has("full_name")}),r.has("full_name")&&n.jsx(u,{children:r.get("full_name")})]})}const C=`import { ErrorMessage, Field, Label } from "@/components/ui-kit/fieldset";
import { Input } from "@/components/ui-kit/input";
...
`;function v(){return n.jsxs(i,{children:[n.jsx(a,{children:"CVC"}),n.jsx(e,{className:"max-w-24",name:"cvc",pattern:"[0-9]*"})]})}const N=`import { Field, Label } from "@/components/ui-kit/fieldset";
import { Input } from "@/components/ui-kit/input";
...
`;function S(){let[r,t]=o.useState("");return n.jsxs(i,{children:[n.jsx(a,{children:"Full name"}),n.jsx(e,{name:"full_name",value:r,onChange:l=>t(l.target.value)})]})}const W=`import { Field, Label } from "@/components/ui-kit/fieldset";
import { Input } from "@/components/ui-kit/input";
