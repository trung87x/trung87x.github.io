  ...
  const layouts = [
    {
      ...
      name: "Basic",
      component: <Basic />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/sidebar/basic.jsx"),
    },
    {
      id: "02",
      name: "With Logo",
      component: <WithLogo />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/sidebar/with-logo.jsx"),
    },
    {
      id: "03",
      name: "With Icons",
      component: <WithIcons />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/sidebar/with-icons.jsx"),
    },
    {
      id: "04",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/sidebar/active-state.jsx",
      ),
    },
    {
      id: "05",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/sidebar/sticky-header.jsx",
      ),
    },
    {
      id: "06",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/sidebar/sticky-footer.jsx",
      ),
    },
    {
      id: "07",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/sidebar/section-headings.jsx",
      ),
    },
    {
      id: "08",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/sidebar/space-between.jsx",
      ),
    },
    {
      id: "09",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/sidebar/with-divider.jsx",
      ),
    },
    {
      id: "10",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/sidebar/with-dropdown.jsx",
      ),
    },
  ];
