  ...
  const layouts = [
    {
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/table/basic.jsx"),
    },
    {
      id: "02",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/table/responsive-table.jsx",
      ),
    },
    {
      id: "03",
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/table/full-width.jsx"),
    },
    {
      id: "04",
      name: "Rows as Links",
      component: <RowsAsLinks users={mockUsers} />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/table/rows-as-links.jsx"),
    },
    {
      id: "05",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/table/condensed-spacing.jsx",
      ),
    },
    {
      id: "06",
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/table/grid-lines.jsx"),
    },
    {
      id: "07",
      name: "With Striped Rows",
      component: <StripedRowsTable users={mockUsers} />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/table/striped-rows.jsx"),
    },
    {
      id: "08",
      name: "With Different Heading Color",
      component: <HeadingColorTable users={mockUsers} />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/table/heading-color.jsx"),
    },
    {
      id: "09",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/table/complex-content.jsx",
      ),
    },
    {
      id: "10",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/table/with-pagination.jsx",
      ),
    },
    {
      id: "11",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/table/with-dropdowns.jsx",
      ),
    },
    {
      id: "12",
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/table/in-dialog.jsx"),
    },
  ];
