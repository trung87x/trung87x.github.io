  ...
  const layouts = [
    {
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/avatar/basic.jsx"),
    },
    {
      id: "02",
      name: "With initials",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/avatar/with-initials.jsx",
      ),
    },
    {
      id: "03",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/avatar/initials-fallback.jsx",
      ),
    },
    {
      id: "04",
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/avatar/square.jsx"),
    },
    {
      id: "05",
      name: "Avatar groups",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/avatar/avatar-groups.jsx",
      ),
    },
    {
      id: "06",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/avatar/avatar-button.jsx",
      ),
    },
    {
      id: "07",
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/avatar/avatar-link.jsx"),
    },
  ];
