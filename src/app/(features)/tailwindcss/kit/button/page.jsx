  ...
  const layouts = [
    {
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/button/button-colors.jsx",
      ),
    },
    {
      id: "02",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/button/outline-buttons.jsx",
      ),
    },
    {
      id: "03",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/button/plain-buttons.jsx",
      ),
    },
    {
      id: "04",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/button/disabled-states.jsx",
      ),
    },
    {
      id: "05",
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/button/with-icon.jsx"),
    },
    {
      id: "06",
      name: "Using as a Link",
      component: <ButtonAsLink />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/button/as-link.jsx"),
    },
  ];
