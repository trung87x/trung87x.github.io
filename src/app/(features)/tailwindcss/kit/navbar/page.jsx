  ...
  const layouts = [
    {
      ...
      name: "Basic",
      component: <Basic />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/navbar/basic.jsx"),
    },
    {
      id: "02",
      name: "With Logo",
      component: <WithLogo />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/navbar/with-logo.jsx"),
    },
    {
      id: "03",
      name: "With Active State",
      component: <ActiveState />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/navbar/active-state.jsx"),
    },
    {
      id: "04",
      name: "With Icon Links",
      component: <IconLinks />,
      raw: getRaw("src/app/(features)/tailwindcss/kit/navbar/icon-links.jsx"),
    },
    {
      id: "05",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/navbar/space-between.jsx",
      ),
    },
    {
      id: "06",
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/navbar/with-divider.jsx"),
    },
    {
      id: "07",
      name: "With Dropdown",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/navbar/with-dropdown.jsx",
      ),
    },
    {
      id: "08",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/navbar/avatar-dropdown.jsx",
      ),
    },
    {
      id: "09",
      ...
      raw: getRaw("src/app/(features)/tailwindcss/kit/navbar/mobile-menu.jsx"),
    },
    {
      id: "10",
      ...
      raw: getRaw(
        "src/app/(features)/tailwindcss/kit/navbar/hiding-mobile.jsx",
      ),
    },
  ];
